...
export const SHORTCUTS: ShortcutDefinition[] = [
  ...
  { id: "textTool", keys: "T", description: "Add text clip at playhead" },
  { id: "copy", keys: "Ctrl/Cmd+C", description: "Copy selected clip" },
  { id: "cut", keys: "Ctrl/Cmd+X", description: "Cut selected clip" },
  { id: "paste", keys: "Ctrl/Cmd+V", description: "Paste clip at playhead" },
  ...
  { id: "end", keys: "End", description: "Go to timeline end" },
  {
    id: "multiSelect",
    keys: "Shift+Click",
    description: "Add/remove clip from selection",
  },
];
